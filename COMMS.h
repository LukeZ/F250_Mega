...
#define CMD_TEMP_LOST                   0x2E    // 46   Command gets sent if a sensor is lost or not present, this lets the display not to rely on the last reading forever. Next time a temp is sent means it has been found again. 
