/* F250_SimpleTimer.h     Simple Timer library - for handling timed events without using delays
 * Authors:               Marcello Romani, LukeZ
 *
 ...
 * 
 * The library has also been re-named to F250_SimpleTimer to avoid conflicts with other libraries. 
 *
...
#ifndef F250_SIMPLETIMER_H
#define F250_SIMPLETIMER_H
...
class F250_SimpleTimer {

public:
    // maximum number of timers
    const static int MAX_TIMERS = MAX_SIMPLETIMER_SLOTS;    // See F250_Settings.h under the SIMPER TIMER heading for the definition of MAX_SIMPLETIMER_SLOTS and how it was calculated. 
